module github.com/pvp/proxy-service
...
require (
	...
	github.com/pvp/pkg/crypto v0.0.0
...
replace (
	...
	github.com/pvp/pkg/crypto => ../../pkg/crypto
	...
	github.com/pvp/providers => ../../infrastructure/providers
)
